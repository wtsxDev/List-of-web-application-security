...
<img border="0" height="336" src="https://2.bp.blogspot.com/-Zepq7d0L9cw/WHq0BpuhJ4I/AAAAAAAAByo/_iWiM2nkGBEPupZ76FpH-Aod-HU4C60jgCLcB/s640/web-hackingt.png" width="640" /></div>
...
## Books
   ...
   * http://amzn.to/2jKaVwc The Web Application Hacker’s Handbook: Finding and Exploiting Security Flaws
   * http://amzn.to/2ixyhYd Hacking Web Apps: Detecting and Preventing Web Application Security Problems
   * http://amzn.to/2jK7UvD Hacking Exposed Web Applications
   * http://amzn.to/2jRmzcM SQL Injection Attacks and Defense
   * http://amzn.to/2ixzIWk The Tangled WEB: A Guide to Securing Modern Web Applications
   * http://amzn.to/2ixzQFk Web Application Obfuscation: '-/WAFs..Evasion..Filters//alert(/Obfuscation/)-'
   * http://amzn.to/2jRfNn1 XSS Attacks: Cross Site Scripting Exploits and Defense
   * http://amzn.to/2jjAAz2 The Browser Hacker’s Handbook
   * http://amzn.to/2iUQaO8 The Basics of Web Hacking: Tools and Techniques to Attack the Web
   * http://amzn.to/2jR9Oin Web Penetration Testing with Kali Linux
   * http://amzn.to/2isNINT Web Application Security, A Beginner's Guide
   * https://www.crypto101.io/ - Crypto 101 is an introductory course on cryptography
   * http://www.offensive-security.com/metasploit-unleashed/ - Metasploit Unleashed
   * http://amzn.to/2jjEaJn - Security Engineering
